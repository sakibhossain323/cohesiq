...
*Fact-verified via Gemini Deep Research, May 23, 2026. All corrected figures marked ✅ VERIFIED, ⚠️ UPDATED, or ❌ REMOVED.*

---

## Changelog From Previous Version

> The following are **decision-critical** corrections made after systematic fact-verification. Read this before anything else.

| # | Original Claim | Verification Status | Impact |
|---|---|---|---|
| 8 | "No dedicated BD influencer platform exists" | ❌ FALSE — HypeScout is operational | Strategy shifts from first-mover to disruptive challenger |
| 35 | Instagram Basic Display API supports OAuth | ❌ DEPRECATED Dec 2024 | Must use Graph API; requires creator account upgrade flow |
| 44 | Upwork charges 5–20% commission | ⚠️ OUTDATED — now 0–15% variable (since May 2025) | Fixed 8–12% commission model needs redesign |
| 17 | IZEA raised $42M Series D in Feb 2025 | ❌ FALSE — IZEA is a public company, $31.2M revenue | Remove from pitch entirely |
| 6 | BD micro-influencer rate: BDT 5,000–10,000 | ⚠️ OVERSIMPLIFIED — range is BDT 100–5,500+ | Payment batching architecture required |
| 15 | Shoppable posts drove $8.2B globally | ❌ UNVERIFIED — figure not found in any source | Remove from all decks |
| 32 | Lessie AI = free fake follower checker | ❌ WRONG TOOL — Lessie AI is a B2B people-search tool | Replace with HypeAuditor's free checker |
| 36 | Meta App Review: 4–6 days | ⚠️ OUTDATED — now 18–20 working days in 2026 | Submit for review 1 month before beta |
| 5 | Engagement: 3–8% micro, 0.5–2% mega | ⚠️ IMPRECISE — verified: 3.86% micro, 1.21% mega | Use precise figures in pitch |
| 2 | 500K creators across platforms | ⚠️ NUANCED — applies to Facebook fashion/beauty Pages specifically | Refine to Facebook-first supply strategy |
...
> ⚠️ UPDATED: All pricing figures corrected from verified sources.
...
### 2.3 ❌ CRITICAL CORRECTION — HypeScout Is the Real Incumbent

> **The foundational assumption that Bangladesh has no structured influencer platform is categorically false. This is the single most important correction in this document.**
...
### 2.4 Native Platform Competitors — Newly Identified (Previously Missed)
...
### 2.5 Competitive Summary Table (Fully Updated)
...
### 3.1 Market Size & Growth ✅ VERIFIED
...
### 3.2 The Creator Supply — Corrected

> ⚠️ UPDATED: The "500,000 creators with 10,000+ followers" figure refers specifically to **Facebook Pages in fashion and beauty verticals**, not platform-agnostic individual creators across all niches.
...
### 3.3 Engagement Rates — Precise Verified Figures

> ⚠️ UPDATED: Precise verified figures replace earlier ranges.
...
### 3.4 Influencer Rates — Corrected and Expanded

> ⚠️ UPDATED (MAJOR): The original BDT 5,000–10,000 baseline was an oversimplification. The true spectrum is:
...
### 3.5 Creator Communities — Supply-Side Seeding Validated ✅
...
> ✅ CONFIRMED: YouTube Data API v3 retrieves public channel data (subscriber count, video views, engagement, upload timestamps) **without any OAuth from the channel owner**, using only a free API key.
...
### 4.2 Instagram — Critical Architecture Change ❌

> ❌ DEPRECATED: The Instagram Basic Display API reached official end-of-life on **December 4, 2024**. It cannot be used for any new integration.

> ✅ REPLACEMENT: The **Instagram Graph API** requires:
...
### 4.3 Meta App Review — Timeline Updated

> ⚠️ UPDATED: Meta App Review now takes **18–20 working days** in 2026 (was 4–6 days) due to the surge in AI app submissions.
...
### 4.5 Trust & Authenticity — Corrected Tool Stack

> ❌ REMOVED: Lessie AI is not a fake follower checker. It is a B2B people-search and LinkedIn outreach tool. All previous references to it as a platform component are removed.

**Correct approach — proprietary heuristics from public signals:**
...
- Global losses to influencer fraud: **$4.6B annually** (updated from outdated 2019 figure of $1.3B)
- Instagram fraud prevalence: **49% of accounts** (not 45%)
- Conversion loss from >30% fake followers: **58% lower** — verified ✅
...
| Groq / Llama 70B (Bengali) | Unverified | ⚠️ Use Gemini as primary NLP backend; Groq Bengali support not confirmed |
...
> ⚠️ Use **pgvector** instead of ChromaDB. pgvector is a free PostgreSQL extension, production-proven, and well-documented. ChromaDB local support was not verifiable from research sources.

> ⚠️ Use **Gemini 2.5 Flash** as the primary NLP backend. Groq's Bengali support is unverified — do not rely on it as primary.
...
> 🆕 NEW SECTION — Previously absent. Necessary given Bangladesh's regulatory environment.
...
### 7.1 Commission Structure — Updated to Variable Model

> ⚠️ UPDATED: The original fixed 8–12% commission was benchmarked against Upwork's old tiered structure. Since May 2025, Upwork operates a **variable 0–15% fee** based on contract type and demand.
...
> ❌ CORRECTED: IZEA did not raise $42M in Series D. IZEA is a publicly traded company that reported $31.2M in annual revenue for 2025 and pivoted entirely away from SMB clients to achieve profitability.
...
## 8. Critical Blind Spots (Updated & Expanded)
...
## 9. The Upwork Analogy — Revised Assessment
...
## 10. Global Scaling Potential (Verified Numbers)

### Market Fundamentals

| Metric | Verified Figure | Source |
|---|---|---|
| Global influencer platform market (2032) | **$103.79B** (not 2033) | Straits Research ✅ |
| Global platform CAGR | **30.6%** | Straits Research ✅ |
| Alternative forecast (2030) | **$115.54B** at 32.7% CAGR | Research and Markets ✅ |
| Micro-creator market share | **39.35%** (not ~40%) | Mordor Intelligence ⚠️ |
| Nano-creator CAGR through 2031 | **34.92%** (not 36%) | Mordor Intelligence ⚠️ |
| APAC global CAGR range | **30.36%–31.42%** (not 33.90% — that figure was misattributed) | Mordor Intelligence ⚠️ |
...
## Appendix — Verified Key Numbers for Pitch Deck

| Metric | Verified Figure | Source | Status |
|---|---|---|---|
| Bangladesh influencer market (2024) | $30.4M | Statista | ✅ Verified |
| Bangladesh influencer market (2028) | $45.3M at 10.47% CAGR | Statista | ✅ Verified |
| BD active social media users | 50M+ | Financial Express | ✅ Verified |
| BD internet users | 120M+ | Financial Express | ✅ Verified |
| BD fashion/beauty Facebook Pages | 500,000+ | Emerald Journal | ⚠️ Sector-specific, not all-creator |
| Micro-influencer engagement rate | 3.86% | Spiralytics | ⚠️ Updated from 3–8% range |
| Mega-influencer engagement rate | 1.21% | Spiralytics | ⚠️ Updated from 0.5–2% range |
| BD influencer rate range | BDT 100 – 5,500+ | Business Standard | ⚠️ Updated from BDT 5K–10K |
| Global influencer marketing (2025) | ~$32.55B | IMH Benchmark Report | ✅ Verified |
| Global platform market by 2032 | $103.79B | Straits Research | ⚠️ Year corrected from 2033 |
| Global platform CAGR | 30.6–32.7% | Multiple sources | ✅ Verified |
| Micro-creator market share | 39.35% | Mordor Intelligence | ⚠️ Updated from ~40% |
| Nano-creator CAGR through 2031 | 34.92% | Mordor Intelligence | ⚠️ Updated from 36% |
| SEA creator-attributed ecommerce | $21B of $38–46B total | Cube × impact.com | ✅ Verified |
| Average ROI per $1 influencer spend | $5.78 | Nielsen | ✅ Verified |
| 86% of marketers use influencers | Yes | Mordor Intelligence | ✅ Verified |
| Annual global influencer fraud losses | **$4.6B** | ContentGrip | ⚠️ Updated from $1.3B (2019 figure) |
| Instagram influencer fraud prevalence | **49%** | IMH / CHEQ | ⚠️ Updated from 45% |
| Conversion loss from >30% fake followers | 58% lower | DialZara, Emerge | ✅ Verified |
| HypeAuditor detection rate | 95% across 53 patterns | HypeAuditor | ✅ Verified |
| Meta App Review timeline (2026) | **18–20 working days** | Reddit, Meta Devs | ⚠️ Updated from 4–6 days |
| TikTok App Review timeline | 1–3 business days | TikTok for Developers | ✅ Verified |
| Upwork commission rate (current) | **0–15% variable** | Upwork, GigRadar | ⚠️ Updated from 5–20% tiered |
| bKash Merchant API (sandbox) | Available | bKash, 6amTech | ✅ Verified |
| Neo4j Community node limits | None (since v3.0) | Neo4j Docs | ✅ Verified |
| BanglaBERT (HuggingFace) | Available, free | HuggingFace, GitHub | ✅ Verified |
| Gemini 2.5 Flash free tier | 1,500 req/day, no credit card | Google AI Studio | ✅ Verified |
| HypeScout (BD incumbent) | Operational, $280K pre-seed, bKash integrated | Dhaka Tribune, TBS | ❌ Previously missed — now confirmed |
| Shoppable posts $8.2B revenue | Not found in any source | N/A | ❌ Removed — unverifiable |
| IZEA $42M Series D | False — IZEA is public, $31.2M annual revenue | Seeking Alpha | ❌ Removed |
| Lessie AI fake follower checker | False — it is a B2B people-search tool | Futurepedia, TAAFT | ❌ Removed |
| Groq Bengali language support | Unverified | No sources found | ⚠️ Use Gemini instead |
| ChromaDB local support | Unverified | No sources found | ⚠️ Use pgvector instead |

---

*Report updated May 23, 2026 based on Gemini Deep Research systematic fact-verification across 55 claims. Primary corrections: HypeScout incumbent discovery, Instagram Basic Display API deprecation, Upwork fee restructure, IZEA funding claim removal, Lessie AI misidentification, fraud loss scale update, engagement rate precision, influencer rate correction, and Meta App Review timeline. All market figures are now source-verified.*
