...
> **Moved from repo root `youtube_implementation.md` on 2026-06-07.**
> This is the reference document for the YouTube API integration: endpoints, field mappings, verification commands, and unit completion status. See also [`srs-revisions-26-06-07.md`](srs-revisions-26-06-07.md) §3 for the formal SRS record, and [`youtube-task-26-06-07.md`](youtube-task-26-06-07.md) for the unit task tracker.
...
- `backend/app/creators/normalization.py` for Tier-0 normalization (niche, language, city, tier)
- `backend/alembic/versions/0016_add_api_verified_social_profile_fields.py`
- `backend/alembic/versions/0017_restore_social_creator_platform_unique.py`
...
⚠️ **Quota note:** `Search.list` costs 100 units/call. Do not use in any loop or seeding script (plan.md D8). Use `channels?handle=` (1 unit) for automated discovery.
