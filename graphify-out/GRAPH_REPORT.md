...
## Summary
- 1444 nodes · 3268 edges · 99 communities (89 shown, 10 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 572 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3404d258`
...
- `UUID` --uses--> `get_db`  [INFERRED]
  backend/app/creators/router.py → backend/app/common/dependencies.py
- `User` --uses--> `get_db`  [INFERRED]
  backend/app/creators/router.py → backend/app/common/dependencies.py
- `AsyncSession` --uses--> `get_db`  [INFERRED]
  backend/app/creators/router.py → backend/app/common/dependencies.py
...
Cohesion: 0.12
Nodes (103): User, AsyncSession, bool, CollabHistoryCreate, CreatorProfileUpdate, Depends, get_current_user, get_db (+95 more)

### Community 1 - "API Endpoint Routers"
Cohesion: 0.06
Nodes (73): brand_reviews(), creator_applications(), creator_reviews(), Creator views their own application history., Public reviews for a creator., Public reviews for a brand., login(), me() (+65 more)

### Community 2 - "Base UI Components"
Cohesion: 0.05
Nodes (44): cn(), AccordionContent(), AccordionItem(), AccordionTrigger(), CardAction(), CardDescription(), CardFooter(), Field() (+36 more)
...
Cohesion: 0.04
Nodes (47): agents.md — Influencer Matching Platform, API Routes to Implement, Architecture: Modular Monolith, Auth Routes, Backend Implementation, Brand Dashboard, Brand Registration Flow (single page), Brand Routes (+39 more)
...
Cohesion: 0.16
Nodes (26): BrandCard(), CampaignCard(), CampaignFilters(), CreatorProfileHeader(), CampaignDetailPage(), CampaignDetailPageProps, CreatorProfilePageProps, daysUntil() (+18 more)

### Community 10 - "Frontend API Queries"
Cohesion: 0.09
Nodes (23): getActiveCampaigns(), getCampaignById(), getCampaigns(), getCampaignsByBrandId(), getCreators(), CampaignCardProps, CampaignFiltersComponentProps, CreatorCard() (+15 more)

### Community 11 - "Application Status Configs"
Cohesion: 0.10
Nodes (24): ApplicationStatusBadge(), ApplicationStatusBadgeProps, statusConfig, niches, platforms, statuses, languages, niches (+16 more)
...
Cohesion: 0.11
Nodes (25): getApplicationById(), getApplications(), getApplicationsByBrandId(), getApplicationsByCampaignId(), getApplicationsByCreatorId(), updateApplicationStatus(), getBrandById(), getBrands() (+17 more)

### Community 14 - "Backend Pydantic Schemas"
Cohesion: 0.17
Nodes (28): ApplicationCreate, ApplicationStatusUpdate, AsyncSession, CampaignCreate, CampaignStatusUpdate, CampaignUpdate, ReviewCreate, UUID (+20 more)
...
Cohesion: 0.13
Nodes (22): LoginRequest, RegisterRequest, TokenResponse, UserOut, str, BaseModel, BrandProfileOut, BrandProfileUpdate (+14 more)
...
Cohesion: 0.12
Nodes (15): Footer(), Navbar(), navLinks, Button(), CalendarDayButton(), InputGroup(), InputGroupAddon(), inputGroupAddonVariants (+7 more)
...
Cohesion: 0.17
Nodes (18): deliverableLabels, DeliverableTable(), DeliverableTableProps, deliverableLabels, RateCardTable(), RateCardTableProps, CampaignDeliverable, CreatorRateCard (+10 more)
...
## Knowledge Gaps
- **395 isolated node(s):** `Config`, `AsyncSession`, `str`, `BrandProfileUpdate`, `int` (+390 more)
...
- **Why does `cn()` connect `Base UI Components` to `Dashboard Layout & Navigation`, `State Actions & Typography`, `Feature Components & Cards`, `Frontend API Queries`, `Application Status Configs`, `Global UI Navigation & Controls`, `Modals & Action Dialogs`, `Alert Dialog UI Primitives`, `Rates & Deliverables Tables`, `ButtonGroup UI Components`, `Social Profiles UI Components`, `Context Menu UI Components`, `Dropdown Menu UI Components`, `Carousel UI Components`, `Form Input Controls`, `Drawer UI Components`, `Chart UI Components`, `Navigation Menu UI Components`, `Breadcrumb UI Components`, `Empty State UI Components`, `Toggle Group UI Components`, `Alert UI Components`, `Community 60`, `Community 64`, `Community 65`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `get_db` connect `API Endpoint Routers` to `FastAPI Models & Authentication`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `register_user()` connect `Auth & Security Services` to `FastAPI Models & Authentication`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Are the 51 inferred relationships involving `get_db` (e.g. with `AsyncSession` and `Depends`) actually correct?**
  _`get_db` has 51 INFERRED edges - model-reasoned connections that need verification._
- **Are the 38 inferred relationships involving `CreatorProfile` (e.g. with `AsyncSession` and `bool`) actually correct?**
  _`CreatorProfile` has 38 INFERRED edges - model-reasoned connections that need verification._
...
- **Should `FastAPI Models & Authentication` be split into smaller, more focused modules?**
  _Cohesion score 0.12268632268632268 - nodes in this community are weakly interconnected._