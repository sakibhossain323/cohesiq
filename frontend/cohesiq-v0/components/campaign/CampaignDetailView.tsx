...
import { BadgeCheck, Calendar, Users, Send, CheckCircle2 } from "lucide-react";
import type { Campaign, Brand, ApplicationStatus } from "@/lib/types";
...
export function CampaignDetailView({
  ...
  const [hasApplied, setHasApplied] = useState(!!existingApplicationStatus);
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 flex-wrap">
                    <Avatar className="h-14 w-14 rounded-lg border border-border shrink-0">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-1">
                        ...
                        <span className="text-lg font-semibold text-foreground">
                          {campaign.application_count + (hasApplied && !existingApplicationStatus ? 1 : 0)}
                        </span>
                      </div>
                    </div>
                  ...
                  {!hideApplyButton && campaign.status === "active" && (
                    <div className="mt-6">
                      {existingApplicationStatus || hasApplied ? (
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between rounded-lg border border-primary/20 bg-primary/5 px-4 py-4 sm:px-6 gap-4">
                            ...
                            <div>
                              ...
                              {existingApplicationStatus && (
                                <p className="text-xs text-muted-foreground mt-0.5">
                                  Current Status: <span className="font-semibold capitalize text-foreground">{existingApplicationStatus}</span>
                                </p>
                              )}
                            </div>
                          </div>
