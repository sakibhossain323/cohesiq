...
import { Megaphone, FileText, MessageSquare, Share2, BarChart3, FileSignature } from 'lucide-react'

const creatorNavItems = [
  { href: '/creator/dashboard', label: 'Home', icon: <BarChart3 className="h-4 w-4" /> },
  ...
  { href: '/creator/dashboard/messages', label: 'Messages', icon: <MessageSquare className="h-4 w-4" /> },
