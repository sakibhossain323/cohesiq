...
export default function NewCampaignPage() {
  ...
  const handleBriefResult = (result: BriefAnalysisResult) => {
    setFormData(prev => ({
      ...
      ...(result.campaign_type ? { campaign_type: result.campaign_type } : {}),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const kpi_targets = (formData.kpi_reach || formData.kpi_engagement_rate || formData.kpi_conversions || formData.kpi_roi_target) ? {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Define the collaboration model and success metrics.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(val) => setFormData({ ...formData, campaign_type: val })}
              >
            ...
            <div>
              <Label className="mb-2 block">KPI Targets (optional)</Label>
