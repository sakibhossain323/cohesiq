    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <div className="mx-auto max-w-2xl w-full text-center">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {/* Creator Option */}
          <Card className="cursor-pointer transition-all hover:border-primary hover:shadow-md" onClick={() => handleSelectRole('creator')}>
            <CardHeader>
          ...
          {/* Brand Option */}
          <Card className="cursor-pointer transition-all hover:border-primary hover:shadow-md" onClick={() => handleSelectRole('brand')}>
            <CardHeader>
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 mb-4">
